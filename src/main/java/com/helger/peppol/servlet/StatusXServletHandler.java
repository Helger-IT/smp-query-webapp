...
public class StatusXServletHandler implements IXServletSimpleHandler
{
  ...
  public static IJsonObject getDefaultStatusData ()
  {
    ...
    aStatusData.add ("nemhandel.support.enabled", AppConfig.isNemhandelSupportEnabled ());
    aStatusData.add ("sml.ids",
                     new JsonArray ().addAll (PhotonPeppolMetaManager.getSMLConfigurationMgr ()
                                                                     .getAllSorted ()
                                                                     .getAllMapped (ISMLConfiguration::getID)));
